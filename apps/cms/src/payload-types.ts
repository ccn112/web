...
export interface PayloadJob {
  ...
  log?:
    ...
    | null;
  taskSlug?: ('inline' | 'leadFollowup') | null;
  queue?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskLeadFollowup".
 */
export interface TaskLeadFollowup {
  input: {
